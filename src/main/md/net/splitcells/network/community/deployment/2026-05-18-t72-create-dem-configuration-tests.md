...
# Tasks
* [ ] Create Dem configuration serialization.
    ...
    * [ ] Implement optional serialization for all Options, where it makes sense. Currently working on CinServiceInitTest.
    * [ ] Implement optional serialization for all OptionImpls, where it makes sense. Currently working on X.
    * [ ] Require all Options to implement the optional serialization, so none is overlooked.
* [ ] Test SystemCell.
* [ ] Test LiveDistroCell.
