...
* [ ] Adjust the project, so that it can be used for school related scheduling by normal users.
    ...
    * [ ] Create document describing objectives regarding school scheduling. -> The document is located at `net/splitcells/network/objectives/school-organization-project`. I'm creating the draft on [Codeberg](https://codeberg.org/splitcells-net/net.splitcells.network.community/issues/11#issuecomment-1735776) so that unneeded git commit are omitted.
